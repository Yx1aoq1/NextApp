...
import { useDynamicScriptLoader } from '@/hooks/useDynamicScriptLoader'
...
const JSmpegPlayer = forwardRef<JSmpegPlayerRef, Props>((props, ref) => {
  ...
  // 动态加载 JSMpeg 脚本
  const { isReady: isJSMpegReady, error: jsmpegError } = useDynamicScriptLoader(
    '/lib/jsmpeg/jsmpeg.min.js',
    () => typeof window !== 'undefined' && !!window.JSMpeg
  )
